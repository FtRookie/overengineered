...
export class RideMode extends PlayMode {
	...
	constructor(
		...
		// Previous AlignPosition/AlignOrientation approach with MaxForce = math.huge was
		// fighting network replication — it pinned parts to their last-observed position
